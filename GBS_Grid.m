function [route,n] = GBS_Grid(input_map,start_coords,goal_coords,drawMapEveryTime)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if chk == u
            [Visited_Frontier] = U_GBS(ary,n,map);
        end
        if chk == d
            [Visited_Frontier] = D_GBS(ary,n,map);
        end
        if chk == l
            temp = ary(n).l;
            if temp ~= 0
        ...
        if chk == r
            [Visited_Frontier] = R_GBS(ary,n,map);
        end
